  ...
  <div class="container">
    <div class="row">
      <div class="column" style="margin-top: 10%">
        ...
        <a class="button button-redbubble" href="page1.html" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/china.svg" alt="">Hitung Harga CH Tes</a><br>
