...
<head>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <meta charset="utf-8">
  <title>Bulgogi.id | Firsthand Korean Warehouse & Group Order</title>
  <meta name="description" content="#">
  <meta name="author" content="Bulgogi Team's">
  ...
  <!-- Favicon
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <link rel="icon" type="image/png" href="images/bgg_icon.png">
  ...
  <div class="container">
    <div class="row">
      <div class="column" style="margin-top: 10%">
        ...
        <!-- Your Image Here -->
        <img src="images/bgg_icon.svg" class="avatar" srcset="images/bgg_icon.svg 2x" alt="">

        <!-- Title -->
        <h1 role="heading">Bulgogi.id</h1>
        Hi, Welcome To Bulgogi.id

        <!-- Short Bio -->
        <p>Firsthand Korean Warehouse & Group Order</p>
        ...
        <!-- Hitung -->
        <a class="button button-amazon" href="./perhitungan/index.php" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/korea.svg" alt="">Hitung Harga KR</a><br>
        <a class="button button-redbubble" href="./perhitungan/ch.php" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/china.svg" alt="">Hitung Harga CH</a><br>
        <a class="button button-redbubble" href="index_old.html" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/china.svg" alt="">Hitung Harga CH Tes</a><br>

        <!-- CS Bulgogi.id -->
        <a class="button button-kickstarter" href="http://wa.me/6285156226606" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/whatsapp.svg" alt="">Customer Service Bulgogi.id</a><br>

        <!-- Feedback Bulgogi -->
        <a class="button button-messenger" href="https://padlet.com/bulgogikstuff/feedback-for-bulgogi-id-w763fe8gpo01isap" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/read-cv.svg" alt="">Feedback For Bulgogi.id</a><br>

        <!-- Join Warehouse Bulgogi -->
        <a class="button button-coffee" href="https://forms.gle/erkY94Gr2suxjic3A" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/buy-me-a-coffee.svg" alt="">Join WH KR Bulgogi.id</a><br>
        <a class="button button-clubhouse" href="https://forms.gle/VqSBQWjZyuM8BBzr7" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/clubhouse.svg" alt="">Join WH CH Bulgogi.id</a><br>

        <!-- Shopee -->
        <a class="button button-soundcloud" href="https://shope.ee/1VUP1cSYFy" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/generic-shopping-bag.svg" alt="">Shopee Bulgogi.id</a><br>

        <!-- X -->
        <a class="button button-x" href="https://x.com/BulgogiKstuff?s=20" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/x.svg" alt="">Follow Bulgogi on X</a><br>

        <!-- Instagram -->
        <a class="button button-instagram" href="https://www.instagram.com/bulgogi.id/" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/instagram.svg" alt="">Instagram</a><br>

        <!-- Line -->
        <a class="button button-line" href="https://line.me/ti/p/8a4LeL7LnC" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/line.svg" alt="">GO Girl Group 1 (Chat Admin)</a><br>
        <a class="button button-line" href="https://line.me/ti/g/pMMy6bt2er" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/line.svg" alt="">GO Girl Group 2</a><br>
        <a class="button button-line" href="https://line.me/ti/g/GcC66dzZ_W" target="_blank" rel="noopener" role="button"><img class="icon" src="images/icons/line.svg" alt="">GO Boy Group </a><br>
        ...
        -->
        <!-- <p>Made With<a href="#"> ˚ʚ♡ɞ˚</a> by Bulgogi.id Team's <a href="https://littlelink.io" target="_blank" rel="noopener" role="button">LittleLink</a>.</p> -->
        <p>Made With<a href="#"> ˚ʚ♡ɞ˚</a> by Bulgogi.id Team's.</p>
