...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Hitung Harga Jajanan China</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Hitung Harga Jajanan China GO By Bulgogi</h6>
        </nav>
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Input Harga CH</p>
              </div>
            </div>
            <form method="post">
              <div class="card-body">
                <p class="text-uppercase text-sm">Rate CH GO By Bulgogi 2300</p>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Harga Barang</label>
                      <input class="form-control" name="harga_ch" type="number" placeholder="Contoh : 5 atau 15" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Jumlah Member GO Yang Coret</label>
                      <input class="form-control" name="coret_ch" type="number" placeholder="Input Hanya Berupa Angka" required>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <button class="btn btn-primary btn-sm ms-auto" name="hitung_ch">Hitung</button>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <?php
    if (isset($_POST['hitung_ch'])) {
      $harga_ch = $_POST['harga_ch'];
      $coret_ch = $_POST['coret_ch'];
      $rate_go = 2270;
      $shipping1 = 10;
      $shipping2 = 12;
      $shipping3 = 15;
      ...
      $fee_wh = 3000;
      $fee_co = 15000;
      $hitung1 = ($harga_ch + $shipping1 / $coret_ch) * $rate_go + ($fee_co / $coret_ch + $fee_admin + $fee_wh);
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Harga Jajanan China GO By Bulgogi</h6>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Harga Bersih CH</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo '¥ ' . $harga_ch; ?></p>
                        <p class="text-xs text-secondary mb-0"><?php echo $harga_ch . 'r' ?></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="text-xm font-weight-bold mb-0"><?= $coret_ch ?></span>
                      </td>
                      <td class="align-middle text-center text-sm">
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0"><?php echo $shipping2 . 'r'; ?></p>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
                            ...
                            <p class="text-xs text-secondary mb-0"><?php echo $shipping3 . 'r'; ?></p>
                          </div>
                        </div>
                      </td>
                      <td>
